...
public class Timus5 {
    public static void main(String[] args) throws IOException {
        ...
        Reader reader = oj ? new InputStreamReader(System.in) : new FileReader("Q:\\IdeaProjects\\out\\production\\IdeaProjects\\Timus\\input.txt");
...
class Sqrt {
    private Stack<Long> longStack = new Stack<>();
    ...
    public void push(String input) {
        ...
        for (String x : toParse) {
            if (x == null || x.equals("") | x.equals(" ")) continue;
